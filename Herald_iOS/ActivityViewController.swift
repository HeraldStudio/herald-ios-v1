...
class ActivityViewController : UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBAction func refreshCache() {
        showProgressDialog()
        ApiSimpleRequest(.Get, checkJson200: true).url("http://115.28.27.150/herald/api/v1/huodong/get").toCache("herald_activity")
    ...
    func loadNextPage() {
        showProgressDialog()
        ApiSimpleRequest(.Get, checkJson200: true).url("http://115.28.27.150/herald/api/v1/huodong/get?page=\(page + 1)")
