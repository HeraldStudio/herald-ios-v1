...
class SettingsHelper {
    static let MODULES : [AppModule] = [
        ...
        // 有卡片的模块
        AppModule(name: "cardextra", nameTip: "一卡通", desc: "提供一卡通消费情况查询、一卡通在线充值以及余额提醒服务", controller: "MODULE_QUERY_CARDEXTRA", icon: "ic_card", hasCard: true),
        AppModule(name: "pedetail", nameTip: "跑操助手", desc: "提供跑操次数及记录查询、早操预报以及跑操到账提醒服务", controller: "MODULE_QUERY_PEDETAIL", icon: "ic_pedetail", hasCard: true),
        AppModule(name: "curriculum", nameTip: "课表助手", desc: "浏览当前学期的课表信息，并提供上课提醒服务", controller: "MODULE_QUERY_CURRICULUM", icon: "ic_curriculum", hasCard: true),
        AppModule(name: "experiment", nameTip: "实验助手", desc: "浏览当前学期的实验信息，并提供实验提醒服务", controller: "MODULE_QUERY_EXPERIMENT", icon: "ic_experiment", hasCard: true),
        AppModule(name: "lecture", nameTip: "人文讲座", desc: "查看人文讲座听课记录，并提供人文讲座预告信息", controller: "MODULE_QUERY_LECTURE", icon: "ic_lecture", hasCard: true),
        AppModule(name: "jwc", nameTip: "教务通知", desc: "显示教务处最新通知，提供重要教务通知提醒服务", controller: "MODULE_QUERY_JWC", icon: "ic_jwc", hasCard: true),
        AppModule(name: "exam", nameTip: "考试助手", desc: "查询个人考试安排，提供考试倒计时提醒服务", controller: "MODULE_QUERY_EXAM", icon: "ic_exam", hasCard: true),
        
        // 无卡片的模块
        AppModule(name: "seunet", nameTip: "校园网络", desc: "显示校园网使用情况及校园网账户余额信息", controller: "MODULE_QUERY_SEUNET", icon: "ic_seunet", hasCard: false),
        AppModule(name: "library", nameTip: "图书馆", desc: "查看图书馆实时借阅排行、已借书籍和馆藏图书搜索", controller: "MODULE_QUERY_LIBRARY", icon: "ic_library", hasCard: false),
        AppModule(name: "grade", nameTip: "绩点查询", desc: "查询历史学期的科目成绩、学分以及绩点详情", controller: "MODULE_QUERY_GRADE", icon: "ic_grade", hasCard: false),
...
class AppModule {
    ...
    init (name : String, nameTip : String, desc : String,
